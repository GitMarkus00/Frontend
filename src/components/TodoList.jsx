...
function TodoList() {
      ...
      return (
            <div className="todo">
                  ...
                  <DatePicker   onChange={date => inputChanged(date)} label="DD/MM/Year" name="date" value={todo.date} />
                  <TextField variant='standard'  onChange={inputChanged} label="Priority" name="priority" value={todo.priority} />
                  <Button onClick={addTodo} variant='contained' color='success' size='small'>Add</Button>
